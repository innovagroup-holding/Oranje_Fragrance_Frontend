      ...
      <div class="tab-content">
        <div class="tab-pane fade" id="new-product" role="tabpanel">
          <div class="row">
            <div
              ...
              v-for="(product, index) in newProducts.slice(0, 1)"
              :key="index"
            >
        ...
        >
          <div class="row">
            <div
              class="col-xl-3 col-lg-4 col-sm-6"
              v-for="(product, index) in bestProducts.slice(0, 1)"
              :key="index"
            >
              <ProductGridItem :product="product" :layout="layout" />
            </div>
        ...
        <div class="tab-pane fade" id="sale-product" role="tabpanel">
          <div class="row">
            <div
              class="col-xl-3 col-lg-4 col-sm-6"
              v-for="(product, index) in saleProducts.slice(0, 8)"
              :key="index"
            >
              <ProductGridItem :product="product" :layout="layout" />
            </div>
